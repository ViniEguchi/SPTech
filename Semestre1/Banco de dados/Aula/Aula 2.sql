...
insert into revista values
	(1, 'Capricho', 'adolescente'),
	(2, 'Veja', 'noticia');

select * from revista;

-- excluir a coluna categoria
alter table revista drop column categoria;
...
-- atualizar um dado de uma linha que já existe
update revista set cat = 'adolescente'
	where id = 1;

update revista set nome = 'Super Capricho', cat = 'adolescencia'
	where id = 1;

update revista set cat = 'noticia'
	where id = 2;
...
-- insert into 3 só mysql
insert into revista (nome, cat) values
	('Carros', 'carros');

delete from revista
	where id = 5;

-- configurar o auto_increment para começar a partir do 100
...
/*
create table revista (
id it primary key auto_increment,
nome varchar(50)
) auto_increment = 100;
*/
